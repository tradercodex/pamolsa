            ...
            <div className="Claims">
                <div className="content-claims">
                    <div>
                        ...
                        <p className="subtitle-claims">Estimado cliente si requiere una atención inmediata, lo invitamos a usar nuestro canal de atención: (01) 641-9595.
                            Gracias por ayudarnos a mejorar nuestro servicio.</p>
                    </div>
