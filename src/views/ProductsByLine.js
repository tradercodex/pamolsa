...
const ProductByLine = ({ match, location }) => {
    ...
    const apiGetTypes = async () => {
        const response = await Axios.get(`https://www.wspamolsa.com.pe/api/product/types/list?line_id=${line}`);
        setTypes(response.data.data)
    }

    const apiGetBusiness = async () => {
        const response = await Axios.get(`https://www.wspamolsa.com.pe/api/product/business/list?line_id=${line}`);
        setBusiness(response.data.data)
    }

    const apiGetMaterial = async () => {
        const response = await Axios.get(`https://www.wspamolsa.com.pe/api/product/material/list?line_id=${line}`);
