...
const DashboardEditVacant = ({ match }) => {
    ...
    useEffect( async () => {
        ...
        const res = await axios.get(`https://ws.pamolsa.com.pe/api/vacant/find/${id}`)
        setVacant({
                        ...
                        <div className="form-grid">
                            ...
                            <div className="input-ds">
                                ...
                                <div className="img-input-ds">
                                    <img style={{ width: "100%" }} id="imgPerfil" src={`https://` + vacant.file || + require('../images/img/uploadimage.webp')} alt="img" />
                                    <input
                                        type="file"
                                        name="file"
                                        id="profile-image"
