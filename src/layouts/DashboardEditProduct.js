...
const DashboardEditProduct = ({ match }) => {
    ...
    const getProduct = async () => {
        const res = await axios.get(`https://pamolsa-back.herokuapp.com/api/product/find?product_id=${id}`)
        setProduct({
    ...
    const deleteProductRelacionated = (id,i) => async() => {
        ...
        const res = await axios.put(`https://pamolsa-back.herokuapp.com/api/product/related/delete?related_product_id=${id}`,null,config)
