...
const DashboardEditProduct = ({ match }) => {
    ...
    const getProduct = async () => {
        const res = await axios.get(`https://www.wspamolsa.com.pe/api/product/find?product_id=${id}`)
        setProduct({
    ...
    const deleteProductRelacionated = (id,i) => async() => {
        ...
        const res = await axios.put(`https://www.wspamolsa.com.pe/api/product/related/delete?related_product_id=${id}`,null,config)
