                ...
                <div className="info-content">
                    <div className="informs-pdfs">
                        ...
                        <div className="box-informs-pdf" style={{ width: "100%" }}>
                            <a href="https://www.carvajal.com/compromiso-etico/" target="_blank" rel="noopener noreferrer"><InformDownload /></a>
                            <p>Compromiso Ético</p>
                        </div>
                        <div className="box-informs-pdf" style={{ width: "100%" }}>
                            <a href="https://www.carvajal.com/wp-content/uploads/2022/06/Instructivo-linea-etica-2022.pdf" target="_blank" rel="noopener noreferrer"><InformDownload /></a>
                            <p>Instructivo de como reportar un caso en la línea ética</p>
                        </div>
                        <div className="box-informs-pdf" style={{ width: "100%" }}>
                            <a href="https://www.kpmgexternalservices.com.co:1606/organizacioncarvajal/complaint" target="_blank" rel="noopener noreferrer"><InformDownload /></a>
